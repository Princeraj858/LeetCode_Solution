...
| 1726 | [1726. Tuple with Same Product](https://leetcode.com/problems/tuple-with-same-product/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1726_Tuple_with_Same_Product.cpp) | O(N^2) | O(N^2) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Hash Table, Counting |
