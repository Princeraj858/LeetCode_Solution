...
| 15  | [3Sum](https://leetcode.com/problems/3sum/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/15_3Sum.cpp) | O(nlogn +n^2) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-brightgreen) | Array, Two Pointers, Sorting |
...
| 827 | [Making A Large Island](https://leetcode.com/problems/making-a-large-island/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/827_Making_A_Large_Island.cpp) |  |  | ![Difficulty](https://img.shields.io/badge/Difficulty-Hard-red) | Array, Depth-First Search, Breadth-First Search, Union Find, Matrixt |
| 873 | [Length of Longest Fibonacci Subsequence](https://leetcode.com/problems/length-of-longest-fibonacci-subsequence/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/873_Length_of_Longest_Fibonacci_Subsequence.cpp) |  |  | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Hash Table, Dynamic Programming |
| 1079  | [Letter Tile Possibilities](https://leetcode.com/problems/letter-tile-possibilities/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Backtracking/1079_Letter_Tile_Possibilities.cpp) | O(2^N) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Hash Table, String, Backtracking, Counting |
| 1092  | [Shortest Common Supersequence](https://leetcode.com/problems/shortest-common-supersequence/description) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Dynamic%20Programming/1092_Shortest_Common_Supersequence.cpp) | O(M∗N) | O(M∗N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Heard-red) | String, Dynamic Programming |
...
| 1352  | [Product of the Last K Numbers](https://leetcode.com/problems/product-of-the-last-k-numbers/description) | [C++]() | O(1)ForEachOperation  | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Math, Design, Data Stream, Prefix Sum |
...
| 1718 | [Construct the Lexicographically Largest Valid Sequence](https://leetcode.com/problems/construct-the-lexicographically-largest-valid-sequence/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1718_Construct_the_Lexicographically_Largest_Valid_Sequence.cpp) | O(2^N) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Backtracking |
| 1726 | [Tuple with Same Product](https://leetcode.com/problems/tuple-with-same-product/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1726_Tuple_with_Same_Product.cpp) | O(N^2) | O(N^2) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Hash Table, Counting |
| 1752  | [Check if Array Is Sorted and Rotated](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1752_Check_if_Array_Is_Sorted_and_Rotated.cpp) | O(N) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green) | Array |
| 1765  | [Map of Highest Peak](https://leetcode.com/problems/map-of-highest-peak/description) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1765_Map_of_Highest_Peak.cpp) | O(Log(N)) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) |Array, Breadth-First Search, Matrix |
| 1780  | [Check if Number is a Sum of Powers of Three](https://leetcode.com/problems/check-if-number-is-a-sum-of-powers-of-three/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Math%20/1780_Check_if_Number_is_a_Sum_of_Powers_of_Three.cpp) | O(M*N) | O(M*N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Math |
| 1790  | [1790. Check if One String Swap Can Make Strings Equal](https://leetcode.com/problems/check-if-one-string-swap-can-make-strings-equal/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Counting/1790_Check_if_One_String_Swap_Can_Make_Strings_Equal.cpp) |  |  | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green) |Hash Table, String, Counting |
| 1800  | [Maximum Ascending Subarray Sum](https://leetcode.com/problems/maximum-ascending-subarray-sum/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/1800_Maximum_Ascending_Subarray_Sum.cpp) | O(N) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green) |Array |
| 1910  | [Remove All Occurrences of a Substring](https://leetcode.com/problems/remove-all-occurrences-of-a-substring/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Simulation/1910_Remove_All_Occurrences_of_a_Substring.cpp) | O(N) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) |String, Stack, Simulation |
...
| 2116  | [Partition Array According to Given Pivot](https://leetcode.com/problems/partition-array-according-to-given-pivot/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2161_Partition_Array_According_to_Given_Pivot.cpp) | O(N) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Eassy-green) |Array, Two Pointers, Simulation|
...
| 2342 | [Max Sum of a Pair With Equal Sum of Digits](https://leetcode.com/problems/max-sum-of-a-pair-with-equal-sum-of-digits/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2342_Max_Sum_of_a_Pair_With_Equal_Sum_of_Digits.cpp) | O(N) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Hash Table, Sorting, Heap (Priority Queue)|
| 2364  | [Count Number of Bad Pairs](https://leetcode.com/problems/count-number-of-bad-pairs/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2364_Count_Number_of_Bad_Pairs.cpp) | O(N) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Hash Table, Math, Counting |
...
| 2460  | [Apply Operations to an Array](https://leetcode.com/problems/apply-operations-to-an-array/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2460_Apply_Operations_to_an_Array.cpp) | O(N) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green) | Array, Two Pointers, Simulation  |
...
| 2523  | [Closest Prime Numbers in Range](https://leetcode.com/problems/closest-prime-numbers-in-range/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Math%20/2523_Closest_Prime_Numbers_in_Range.cpp) | O(N∗Log(Log(N))) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Math, Number Theory  |
| 2570  | [Merge Two 2D Arrays by Summing Values](https://leetcode.com/problems/merge-two-2d-arrays-by-summing-values/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2570_Merge_Two_2D_Arrays_by_Summing_Values.cpp) | O(N+M) | O(N+M) | ![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green) | Array, Hash Table, Two Pointers  |
| 2579  | [Count Total Number of Colored Cells](https://leetcode.com/problems/count-total-number-of-colored-cells/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Math%20/2579_Count_Total_Number_of_Colored_Cells.cpp) | O(1) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Math |
...
| 2965  | [Find Missing and Repeated Values](https://leetcode.com/problems/find-missing-and-repeated-values/description/) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/2965_Find_Missing_and_Repeated_Values.cpp) | O(N*N) | O(1) | ![Difficulty](https://img.shields.io/badge/Difficulty-Eassy-green) | Array, Hash Table, Math, Matrix |
| 3066 | [Minimum Operations to Exceed Threshold Value II](https://leetcode.com/problems/minimum-operations-to-exceed-threshold-value-ii/description) | [C++](https://github.com/KanishkRajTech/LeetCode_Solution/blob/main/Array/3066_Minimum_Operations_to_Exceed_Threshold_Value_II.cpp) | O(NLogN) | O(N) | ![Difficulty](https://img.shields.io/badge/Difficulty-Medium-yellow) | Array, Heap (Priority Queue), Simulation |
